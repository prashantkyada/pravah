...
class Paginator{
...

	{
...

		{
			...
			$this->return = ($this->current_page > 1 And $this->items_total >= 10) ? "<div class='row'><div class='col-sm-12'><ul class='pagination'><li class='page-item'><a class=\"page-link\" href=\"$_SERVER[PHP_SELF]?page=$prev_page&ipp=$this->items_per_page$this->querystring\">Previous</a></li> ":"<div class='row'><div class='col-sm-12'><ul class='pagination'><li class='page-item'><a href=\"javascript:;\" class=\"page-link disabled\" tabindex=\"-1\">Previous</a></li> ";
		...
		else
		{
...

			{
				...
				$this->return .= ($i == $this->current_page) ? "<div class='row'><div class='col-sm-10'><ul class='pagination'><li class='page-item active'><a class=\"page-link\" href=\"#\">$i</a></li> ":"<li class='page-item'><a class=\"page-link\" href=\"$_SERVER[PHP_SELF]?page=$i&ipp=$this->items_per_page$this->querystring\">$i</a></li> ";
...

	{
		...
		return "<div class='col-sm-2 float-sm-right'><div class='form-row mt-5 text-left'><div class='col'><span class=\"text-muted\">Rows:</span> <select class=\"border rounded text-muted\" onchange=\"window.location='$_SERVER[PHP_SELF]?page=1&ipp='+this[this.selectedIndex].value+'$this->querystring';return false\">$items</select></div></div></div></div>\n";
	...
	function display_jump_menu()
	{
		...
		/*return "<div class='row'><div class='col-sm-5'><div class='col-lg-2'><span class=\"text-muted\">Page:</span><select class=\"selector\" onchange=\"window.location='$_SERVER[PHP_SELF]?page='+this[this.selectedIndex].value+'&ipp=$this->items_per_page$this->querystring';return false\">$option</select></div></div></div></div>\n";*/
