...
$pdf->SetTitle('A5 PDF Example');
$pdf->SetSubject('Generating A5 PDF in PHP');
 ...
 <!--Body content-->
    <table class="order-form" border="0" cellspacing="0" cellpadding="5" width="100%">
		<tbody>
			<tr>
				<td align="left">
					<img src="images/Pravah Logo CDR-11.png" alt="logo" width="100">
				</td>
				<td align="right">
					<div>
...
/*$html = '<h1 style="text-align:center;">Hello, this is an A5 PDF</h1>
         <p>This PDF was generated using TCPDF in PHP.</p>';
*/
$pdf->writeHTML($html, true, false, true, false, '');

// Output the PDF (force download)
$pdf->Output('a5_document.pdf', 'D');
?>
