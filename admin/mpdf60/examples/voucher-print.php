...
$purchase_date = date("d F Y");
$name = $_GET['name'];
$email = $_GET['email'];
$mobile = $_GET['mobile'];
$price = $_GET['price'];
$ti = urldecode($_GET['tit']);
$desc = urldecode($_GET['descr']);	
$voucherid = $_GET['voucherid'];
		
$newstring = substr($voucherid, -6);
...
.footer_alternative{float:left; width:100%; text-align:center; font-size:18px; padding-top:5px;}
.purchase_date{float:left; width:22%;}
.purchase_date_desc{float:left; width:48%;}
	...
	<div class="sub_div">
       ...
       <div class="descript_main">
       		<div class="descript_voucher">
                ...
                <div class="voucher_detail">'.$ti.'</div>
            </div>
            <div class="descript_date">
            	<div class="purchase_date">Purchase date :</div>
                <div class="purchase_date_desc">'.$purchase_date.'</div>
                <div class="value">Value : AED '.$price.'</div>
				<div class="purchase_date">Voucher number :</div>
                <div class="purchase_date_desc">'.$result.'</div>
            </div>
            ...
            <div class="contect_detail">
                ...
                <div class="contect_desc">'.$name.'<br />
                '.$mobile.'<br />
                '.$email.'
                </div>
            </div>
            <div class="footer_boom">An Al Boom representative will contact you shortly to arrange your booking.</div>
			<div class="footer_alternative">Alternatively, you can contact us at 04 3422993 or abdiving@emirates.net.ae.</div>
       </div>
    </div>
</div>
</body>
