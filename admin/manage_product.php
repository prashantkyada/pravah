                    ...
                    <div class="col-lg-12">
						...
						<input type="hidden" name="id" value="<?php echo $_GET['id']?>" />
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                  <select name="category_id" id="category_id" class="nostyle form-control" onchange="get_country()" style="cursor:pointer;">
									<?php 
							...
							else
						{
							...
							<div class="form-group">
								...
								<div class="col-lg-4">
     							 ...
     							 <button type="button" id="add_first" class="btn btn-info add-btn" onClick="OnButtonClick()">Add</button>
   							 </div>
...
function deleteRow(button) {
  // Remove the row associated with this button
